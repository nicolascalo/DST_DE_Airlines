...
classification_pipelines = {
    ...
    'Logistic_OVO':[Pipeline([('preprocessor', preprocessor_cls),('classifier',OneVsOneClassifier(LogisticRegression(max_iter=1000))) ]), get_grid_params('DecisionTree','Logistic_OVO')],
    'Logistic_OVR':[Pipeline([('preprocessor', preprocessor_cls),('classifier',OneVsRestClassifier(LogisticRegression(max_iter=1000))) ]), get_grid_params('DecisionTree','Logistic_OVR')]
}
