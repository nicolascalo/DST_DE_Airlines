...
class Payload_flight(BaseModel):
    ...
    flightLegs_departureInformation_airport_places_departurePositionTerminal_boardingTerminal : Optional[str]
    flightLegs_departureInformation_airport_places_departurePositionTerminal_gateNumber : Optional[str]
